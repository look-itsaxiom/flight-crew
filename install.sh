...
echo "📋 Next Steps:"
echo ""
echo "1. Review and edit .flight-crew.yml to configure the target branch"
...
echo "   git push"
echo ""
echo "4. Create a staging/development branch if you don't have one:"
echo "   git checkout -b develop"
echo "   git push -u origin develop"
echo ""
echo "5. Start using the system by creating an issue and labeling it 'ready'!"
echo ""
echo "📚 Documentation:"
